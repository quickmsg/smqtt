...
public class SmqttSessionRecord extends TableRecordImpl<SmqttSessionRecord> implements Record6<String, String, Integer, Integer, String, LocalDateTime> {
    ...
    @Override
    public SmqttSessionRecord value4(Integer value) {
        setRetain(value);
        return this;
    }
    ...
    @Override
    public SmqttSessionRecord values(String value1, String value2, Integer value3, Integer value4, String value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SmqttSessionRecord(String topic, String clientId, Integer qos, Integer retain, String body, LocalDateTime createTime) {
        super(SmqttSession.SMQTT_SESSION);
